    ...
    return (
      <div className="App">
        ...
        <div class="scores p1">
          ...
          <br/>
        <p class="ties">To Reset ScoreBoard Please Refresh the Page!</p>
        <br/>
        <p className="ortext">OR</p><br/>
        <button onClick={()=> this.resetScoreboard()} className="resetbutton">Reset</button>
        </div>
      </div>
    );
  }
